...
function Navbar() {
    ...
    // it toggles the state of the IsOpen variable to the opposite of its current boolean state
        ...
        <nav className='navbar'>
          ...
          <div className='navbar-container'>
            ...
            <div className='nav-button-container'>
              ...
              {/* the button calls the toggledrownfunction when clicked which causes isOpen to equal true which renders the menu*/}
